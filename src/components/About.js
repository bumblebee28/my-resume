  ...
  return (
    <div>
        ...
        <div className="about">
          ...
          And as a 'ever-hungry' student for new intriguing techs and information, I keep on learning new things. 
          I don't want to miss anything life has to offer to me. So, I explore every other opportunity i can get a hold of. </p>
